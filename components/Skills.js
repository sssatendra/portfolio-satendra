                        ...
                        <div className=" flex justify-center items-center">
                            ...
                            <div className="px-5 py-2 w-2/3">
                                ...
                                <div className="h-3 mx-auto relative max-w-xl rounded-full overflow-hidden">
                                    ...
                                    <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 3 }} className="h-full animate-pulse bg-blue-800 absolute" style={{ width: `${skill.level}` }}></motion.div>
                                </div>
                            </div>
                        </div>
                    ))
