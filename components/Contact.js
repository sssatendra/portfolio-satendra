    ...
    <div className="flex w-full justify-center items-center flex-col lg:flex-row pt-16" id="contact">
      <div className="w-full lg:w-2/3">
        ...
        <form action="" className="flex flex-col relative p-5 mx-5" onSubmit={submitForm}>
          <input value={name} onChange={(e) => setName(e.target.value)} type="text" className="bg-gray-600 p-3 lg:p-5 my-2 rounded-xl float-right outline-none active:bg-blue-600" placeholder="Name" required />
          <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className="bg-gray-600 p-3 lg:p-5 my-2 rounded-xl outline-none active:bg-blue-600" placeholder="Email" required />
          <input type="text" value={subject} onChange={(e) => setSubject(e.target.value)} className="bg-gray-600 p-3 lg:p-5 my-2 rounded-xl outline-none active:bg-blue-600" placeholder="Subject" required />
          <textarea type="text" value={message} onChange={(e) => setMessage(e.target.value)} className="bg-gray-600 p-3 py-16 lg:p-5 my-2 rounded-xl outline-none active:bg-blue-600" placeholder="Message" required />
